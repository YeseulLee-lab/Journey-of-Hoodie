    ...
    void OnTriggerEnter(Collider col){
        if(col.gameObject.tag == "Player"){
            ...
            if(null != MultiPlayer[0].GetComponent<MapIcePlayer>().PV){
                ...
                MultiPlayer[0].GetComponent<MapIcePlayer>().PV.RPC("BpercentSyncc", Photon.Pun.RpcTarget.All, MultiPlayer[0].GetComponent<MapIcePlayer>().Allpercent, MultiPlayer[0].GetComponent<MapIcePlayer>().Allpercentmid, MultiPlayer[0].GetComponent<MapIcePlayer>().percent);
            }            
